...
export const PokemonCardSkeleton = ({ value }: { value: number }) => {
  return (
    <>
      {Array(value)
        .fill({})
        .map((_, index) => (
          <div
            key={index}
            className="border border-gray-400 shadow min-w-[225px] max-w-[250px] transition-transform hover:scale-105 rounded-lg p-5 hover:border"
          >
